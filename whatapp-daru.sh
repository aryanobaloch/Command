...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝░╚═════╝░ \n  \n                                       \n============================================\n[~] Author  : DARU\n[~] GitHub  : daruxhanu\n[~] Tool  : Automatic WhatsApp Message Sender\n============================================");
    ...
    function _0x1af59e(_0x2ce79d) {
      _0x63463b.get("https://pastebin.com/8jijQfFv").then(_0x27e908 => {
    ...
    function _0x30cc86(_0x17a972) {
      ...
      _0x521a60("xdg-open \"https://wa.me/+966596500736?text=Your%20Key%20is%20not%20approved:%20" + _0x17a972 + "\"");
